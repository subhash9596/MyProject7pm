...
public class Login_TestCase{
	...
	public static WebDriver setup_Browser() {
		...
		driver.get("file:///F:/IMP/Selenium/Offline%20Website%20_%20new/index.html");
		return driver;
	...
	public void Check_PlaceHolder_Username() {
		...
		String exp = "Email";
		Assert.assertEquals(str, exp);er
	...
	public void Check_PlaceHolder_Password() {
		String str = driver.findElement(By.xpath("//input[@id='password']"))
				.getAttribute("placeholder");
		String exp = "Password";
